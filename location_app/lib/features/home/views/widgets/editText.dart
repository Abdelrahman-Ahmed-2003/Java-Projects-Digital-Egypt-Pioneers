            ...
            child: TextFormField(
              ...
              decoration: const InputDecoration(
                ...
                focusedErrorBorder: OutlineInputBorder(
                  borderSide: BorderSide(
                    color:
                        Color.fromARGB(255, 4, 33, 73), // Same as focusedBorder
                  ),
                ),
              ),
            )),
        ...
        ElevatedButton(
          ...
          onPressed: () async {
            if (formKey.currentState!.validate()) {
              ...
              if (cubit.destenations
                  .any((area) => area.name == controller.text)) {
                QuickAlert.show(
                    ...
                    text: 'Please enter another location or spacefic area in it which not founded in another loication',
                ...
                state = cubit.state;
                print(state is DataLoading?'state is loding':'state is erro');
                ...
                if (state is DataLoading) {
                  ...
                  if(error == 'PlatformException(IO_ERROR, gipi: UNAVAILABLE, null, null)' || error == 'PlatformException(IO_ERROR, UNAVAILABLE: Unable to resolve host geomobileservices-pa.googleapis.com, null, null)')
                  {
